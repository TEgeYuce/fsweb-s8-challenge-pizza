...
const hataMesajlari = {
  isim: "Ad Soyad alanı en az 3 karakter içermelidir.",
  malzemeler: "En az 4 malzeme, en fazla 10 malzeme seçmelisiniz. Her ek malzeme 5₺'dir.",
};
...
const OrderForm = () => {
  ...
  axios
    ...
    .then((res) => {
      ...
      history.push("/OrderResult", { response: res.data });
    })
    .catch((error) => {
              ...
              <FormGroup>
                ...
                <div className="customRadio">
                  <label class="boyutContainer">
                    ...
                    />
                    <span class="checkmark">Küçük</span>
                  </label>
                  <label class="boyutContainer">
                    <Input
                      type="radio"
                      ...
                      onChange={handleChange}
                    />
                    <span class="checkmark">Orta</span>
                  </label>
                  <label class="boyutContainer">
                    <Input
                      type="radio"
                      ...
                      onChange={handleChange}
                    />
                    <span class="checkmark">Büyük</span>
                  </label>
                </div>
              </FormGroup>
              <FormGroup>
                ...
                >
                  ...
                  <option value="İnce Kenarlı">İnce Kenarlı</option>
                </Input>
              </FormGroup>
            </FormGroup>
